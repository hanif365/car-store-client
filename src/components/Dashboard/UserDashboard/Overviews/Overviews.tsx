...
const UserOverviews = () => {
  ...
  if (error) {
    return (
      <div className="min-h-[50vh] flex justify-center items-center p-4">
        <div className="text-red-500 text-sm sm:text-base md:text-xl text-center">
  ...
  // container mx-auto px-2 sm:px-1 py-3 sm:py-6 max-w-full
  return (
      ...
      <div className="max-w-full">
        ...
        >
          ...
          >
            ...
            <div className="bg-blue-50 px-4 sm:px-5 py-2">
          ...
          >
            ...
            <div className="bg-green-50 px-4 sm:px-5 py-2">
          ...
          >
            ...
            <div className="bg-purple-50 px-4 sm:px-5 py-2">
          ...
          >
            ...
            <div className="bg-orange-50 px-4 sm:px-5 py-2">
