...
import { FaChartBar, FaShoppingCart, FaUserCircle, FaSignOutAlt, FaCar } from "react-icons/fa";
...
const UserDashboard = () => {
  ...
  const navItems = [
    { id: 'overviews', label: 'Overviews', icon: <FaChartBar />, path: '/user/dashboard' },
    { id: 'orders', label: 'Orders', icon: <FaShoppingCart />, path: '/user/dashboard/orders' },
    { id: 'profile', label: 'Profile', icon: <FaUserCircle />, path: '/user/dashboard/profile' },
  ];
